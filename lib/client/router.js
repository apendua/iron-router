...
ClientRouter = Utils.extend(IronRouter, {
  ...
  constructor: function (options) {
    ...
    Meteor.startup(function () {
      ...
      self._page = self.options.pageManager || {
                                      setTemplate: noOp,
                                      setLayout: noOp,
                                      setData: noOp,
                                      getData: noOp,
  ...
  renderRegion: function (regionName) {
    return this._page.renderRegion(regionName);
  },
  ...
  autoRender: function () {
    var self = this;
    UI.DomRange.insert(UI.render(UI.Component.extend({
      render: function () {
        return function() { return self.render() };
      },
    })).dom, document.body);
  },
